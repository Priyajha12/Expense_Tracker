...
const Login = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-slate-950 px-4 relative overflow-hidden">
            {/* Decorative Blurs */}
            <div className="absolute top-0 left-0 w-96 h-96 bg-yellow-400/10 rounded-full blur-[100px] -translate-x-1/2 -translate-y-1/2"></div>
            <div className="absolute bottom-0 right-0 w-96 h-96 bg-amber-500/10 rounded-full blur-[100px] translate-x-1/2 translate-y-1/2"></div>
            ...
            <div className="max-w-md w-full bg-slate-900 rounded-3xl shadow-2xl p-10 border border-slate-800 relative z-10">
                <div className="text-center mb-10">
                    ...
                    <p className="text-slate-400 font-medium mt-2">Sign in to your <span className="text-white">personal</span> finance tracker</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    >
                        ...
                        <span className="relative">{isLoading ? 'Authenticating...' : 'Sign In'}</span>
                    </button>
                </form>

                <p className="mt-10 text-center text-slate-400 font-medium">
                    New here?{' '}
                    <Link to="/register" className="text-yellow-400 font-bold hover:text-yellow-300 transition-colors">
                        Create an account
                    </Link>
                </p>
            </div>
